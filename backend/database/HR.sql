...
CREATE TABLE IF NOT EXISTS `db_hr`.`Worker_has_Post` (
  `worker_fio` VARCHAR(70) NOT NULL,
  `post_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`worker_fio`, `post_name`),
  INDEX `fk_Worker_has_Post_Post1_idx` (`post_name` ASC) VISIBLE,
  INDEX `fk_Worker_has_Post_Worker1_idx` (`worker_fio` ASC) VISIBLE,
  CONSTRAINT `fk_Worker_has_Post_Worker1`
    FOREIGN KEY (`worker_fio`)
    REFERENCES `db_hr`.`Worker` (`fio`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Worker_has_Post_Post1`
...
INSERT INTO Worker (fio, birthdate, gender, address, phone, `status`, reason) VALUES 
('Сорокин Егор Андреевич', '1994-08-10', 'мужской', 'г. Симферополь, ул. Севастопольская, д. 12', '+79788993864', 'Работает', null),
('Маматов Сейдамет Русланович', '1992-09-25', 'мужской', 'г. Симферополь, ул. Училищная, д. 16', '+79781962814', 'Работает', null),
('Бойченко Вероника Сергеевна', '1996-04-23', 'женский', 'г. Симферополь, ул. Севастопольская, д. 21', '+79784354312', 'Работает', null),
('Мартышина Ольга Александровна', '1991-03-27', 'женский', 'г. Симферополь, ул. Сакская, д. 9', '+79784506754', 'Работает', null),
('Браилов Аким Эмильевич', '1991-04-13', 'мужской', 'г. Симферополь, ул. Сакская, д. 17', '+79782354567', 'Работает', null),
('Юрьева Маргарита Руслановна', '1992-09-02', 'женский', 'г. Симферополь, ул. Севастопольская, д. 34', '+79783423242', 'Работает', null),
('Артюшкина Анна Дмитриевна', '1994-06-05', 'женский', 'г. Симферополь, ул. Севастопольская, д. 43', '+79785677454', 'Работает', null),
('Родин Максим Алексеевич', '1995-03-12', 'мужской', 'г. Симферополь, ул. Сакская, д. 15', '+79788996437', 'Работает', null),
('Яковчук Елена Владимировна', '1996-09-16', 'женский', 'г. Симферополь, ул. Севастопольская, д. 12', '+79783457652', 'Работает', null),
('Рыль Никита Андреевич', '1995-12-27', 'мужской', 'г. Симферополь, ул. Дунайская, д. 12', '+79786548876', 'Работает', null),
('Авагян Давид Грагатович', '1995-12-23', 'мужской', 'г. Севастополь, ул. Симферопольская, д. 13', '+79783556498', 'Не работает', 'По собственному желанию.');
...
INSERT INTO Worker_has_Post (worker_fio, post_name) VALUES
('Бойченко Вероника Сергеевна', 'Менеджер по закупкам'),
('Яковчук Елена Владимировна', 'Аналитик по закупкам'),
('Сорокин Егор Андреевич', 'Разработчик'),
('Родин Максим Алексеевич', 'Тестировщик'),
('Мартышина Ольга Александровна', 'Менеджер по продажам'),
('Артюшкина Анна Дмитриевна', 'Ключевой менеджер по продажам'),
('Маматов Сейдамет Русланович', 'HR-менеджер'),
('Юрьева Маргарита Руслановна', 'Специалист по оценке персонала'),
('Рыль Никита Андреевич', 'Менеджер по маркетингу'),
('Браилов Аким Эмильевич', 'Специалист по цифровому маркетингу'),
('Сорокин Егор Андреевич', 'Тестировщик');
